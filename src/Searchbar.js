...
export default function Searchbar() {
  ...
  return (
    <div>
      <div class=" bg-[url('./Images/Serch.jpg')]  w-full h-screen flex flex-col items-center justify-center">
        <div class="mb-32">
        ...
        <div class="w-11/12 md:w-8/12 xl:w-1/2 h-auto p-5 rounded-full bg-white flex flex-col">
