...
return (
     <div className='flex justify-between bg-orange-100 h-20 border-b-2 border-orange-300 xl:max-w-7X1 xl:mx-auto max-w-full py[8%] '>
       ...
       <div className='lg:block hidden space-x-8  mr-4 mt-3 text-xl font-serif no-underline'>
          <Link className='hover:text-rose-600  focus:text-rose-600' to="/"> Home </Link>
          ...
          <button onClick='' className='border-solid border-2 border-slate-900 h-10 w-24 bg-orange-500 rounded-xl' >Log In</button>
